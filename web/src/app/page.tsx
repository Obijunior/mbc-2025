      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black tracking-tight leading-[1.1]">
              ...
              <span className="block bg-gradient-to-r from-sky-400 via-sky-300 to-red-400 bg-clip-text text-transparent animate-gradient drop-shadow-2xl">
                reimagined onchain
              </span>
            </h1>
        ...
        <div className={`mt-20 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="relative max-w-5xl mx-auto group">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-sky-500/20 via-purple-500/20 to-red-500/20 blur-3xl -z-10 opacity-50 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="rounded-3xl border border-slate-800/50 bg-slate-900/60 backdrop-blur-xl p-8 sm:p-12 shadow-2xl hover:border-slate-700/50 transition-all duration-500">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-8">
                ...
                <div className="relative group/card">
                  <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 to-transparent rounded-2xl blur-xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-500" />
                ...
                {/* Disbursed */}
                <div className="relative group/card">
                  <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 to-transparent rounded-2xl blur-xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-500" />
        ...
        <div className={`mt-24 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="group/section relative">
              <div className="absolute inset-0 bg-gradient-to-br from-sky-500/10 to-transparent rounded-3xl blur-2xl opacity-0 group-hover/section:opacity-100 transition-all duration-700" />
              <div className="relative h-full rounded-3xl border border-slate-800/50 bg-slate-900/60 backdrop-blur-sm p-8 hover:border-sky-500/40 hover:bg-slate-900/80 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-sky-500/20">
                ...
                <Link
                  href="/donor"
                  className="group/btn inline-flex items-center justify-center w-full gap-2 rounded-xl bg-gradient-to-r from-sky-500 to-sky-600 px-6 py-4 font-bold text-white shadow-lg shadow-sky-900/50 hover:shadow-sky-900/80 hover:scale-[1.05] transition-all duration-300 hover:from-sky-400 hover:to-sky-500"
                >
                  Start Donating
            ...
            {/* For Students */}
            <div className="group/section relative">
              <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-transparent rounded-3xl blur-2xl opacity-0 group-hover/section:opacity-100 transition-all duration-700" />
              <div className="relative h-full rounded-3xl border border-slate-800/50 bg-slate-900/60 backdrop-blur-sm p-8 hover:border-red-500/40 hover:bg-slate-900/80 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-red-500/20">
                ...
                <Link
                  href="/student"
                  className="group/btn inline-flex items-center justify-center w-full gap-2 rounded-xl bg-gradient-to-r from-red-500 to-red-600 px-6 py-4 font-bold text-white shadow-lg shadow-red-900/50 hover:shadow-red-900/80 hover:scale-[1.05] transition-all duration-300 hover:from-red-400 hover:to-red-500"
                >
                  Request Aid
                  <svg className="w-5 h-5 group-hover/btn:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
